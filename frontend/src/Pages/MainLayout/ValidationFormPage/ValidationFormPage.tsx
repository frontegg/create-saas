...
const ValidationFormPage: React.FC = () => {
    ...
    return (
            <div className="sampleformpage">
                ...
                <div className="main">
                    <SampleForm inputs={ContactInputs} customErrors={customErrors} description="Default error messages" header="Validation"/>
                    <SampleForm inputs={LoginInputs} customErrors={customErrors} description="Use the alerts prop to show error messages in Alert components" header="Validation" alerts={true} />
                </div>
            </div>
    )
}
