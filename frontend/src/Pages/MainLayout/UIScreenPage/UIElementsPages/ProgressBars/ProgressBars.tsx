    ...
    return <div className="ProgressBars">
        ...
        <Widget col>
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>&lt;ProgressBar /&gt;</code> component for simple progress bars</span>
                </div>
            </div>
            <Col>
        ...
        <Widget col>
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>&lt;ProgressLine /&gt;</code> component for simple progress bars with <code>colorClass="bg-color"</code> prop</span>
                </div>
            </div>
            <Col>
        ...
        <Widget col>
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>&lt;ProgressBarWithValue /&gt;</code> component for progress bars with text inside</span>
                </div>
            </div>
            <Col>
