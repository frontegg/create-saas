    ...
    return <div className="Breadcrumbs">
        ...
        <Widget col>
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>&lt;Breadcrumbs /&gt;</code> component for breadcrumbs</span>
                </div>
            </div>
        ...
        <Widget col>
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>separator</code> prop for dividers between links</span>
                </div>
            </div>
        ...
        <Widget col>
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>home</code> prop for breadcrumbs. Change the icon using the <code>icon</code> prop.</span>
                </div>
            </div>
