    ...
    return <div className="Images">
        ...
        <Widget col className="flex-wrap">
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>.rounded</code> class for rounded images</span>
                </div>
            </div>
            <Row>
        ...
        <Widget col className="flex-wrap">
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>.rounded-circle-</code> class for circular images</span>
                </div>
            </div>
            <Row>
        ...
        <Widget col className="flex-wrap">
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>.shadow</code> class for raised images</span>
                </div>
            </div>
            <Row>
        ...
        <Widget col>
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>.shadow-outline-color</code> classNames to add an inner border to your images</span>
                </div>
            </div>
