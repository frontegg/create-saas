    ...
    return <div className="Paginations">
        ...
        <Widget col className="flex-wrap">
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use the <code>&lt;Pagination /&gt;</code> component for pagination with numbers and text labels</span>
                </div>
            </div>
            <Pagination page={5}
                count={10}/>
        ...
        <Widget className="flex-wrap" col>
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use any component or text for the <code>prev</code> and <code>next</code> props</span>
                </div>
            </div>
        ...
        <Widget col className="flex-wrap">
            <div className="mb-3">
                ...
                <div className="text-sm font-bold">
                    <span>Use any component or text for the <code>first</code> and <code>last</code> props</span>
                </div>
            </div>
            <Pagination page={5}
