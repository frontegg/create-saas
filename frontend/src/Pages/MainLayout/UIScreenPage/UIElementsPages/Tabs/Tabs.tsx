...
const tabs = [{
    tabId:"tab_favorites",
    label: <><FavoriteBorderOutlinedIcon className="mb-2 mx-2"/><div className="mb-2 mx-2">Favourites</div></>,
...
{
    tabId:"tab_options",
    label: <><DehazeIcon className="mb-2 mx-2"/><div className="mb-2 mx-2">Options</div></>,
...
{
    tabId:"tab_settings",
    label: <><SettingsOutlinedIcon className="mb-2 mx-2"/><div className="mb-2 mx-2">Settings</div></>,
